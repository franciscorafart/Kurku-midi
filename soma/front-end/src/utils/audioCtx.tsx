...
type Effect = ConvolverNode | StereoPannerNode | AnalyserNode | GainNode | DelayNode | WaveShaperNode | AudioWorkletNode
...
const wrapAndConnectEffect = (
    ...
    if(effectConfig.key === 'reverb') {
        ...
        wrappedEffect.setValueAtTime = function(
            wet: number, 
            currentTime: number,
        ) {
            const dry = 1 - wet;
